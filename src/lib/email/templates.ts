...
export const TEMPLATE_VARS: { key: string; label: string; sample: string }[] = [
  ...
  { key: "provable", label: "Proof line (evidence-based)", sample: "Enquiries arrive after hours and go unanswered until morning." },
  { key: "point1", label: "Personal point 1 (biggest challenge)", sample: "Enquiries arrive after hours and go unanswered until morning — leads go cold or buy elsewhere." },
  { key: "point1_lc", label: "Personal point 1 (lowercase, after a colon)", sample: "enquiries arrive after hours and go unanswered until morning — leads go cold or buy elsewhere." },
  { key: "point2", label: "Personal point 2 (website observation, optional)", sample: "on your site I saw online booking, but questions that don't come with a booked slot still wait for a human to reply" },
