...
const caseStudies = [
  {
    ...
    timeline: "6 weeks",
    results: ["85% reduction in response time", "40% decrease in no-shows", "60% reduction in administrative workload", "$120K annual savings estimated"],
  ...
  },
  {
    ...
    timeline: "8 weeks",
    results: ["200+ hours saved per month", "95% reduction in data entry errors", "50% faster order processing", "$80K annual savings estimated"],
  ...
  },
  {
    ...
    timeline: "4 weeks",
    results: ["60% faster enrollment processing", "35% improvement in student engagement", "1,000+ inquiries handled weekly", "$45K annual savings estimated"],
